        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="currency in currencies.data" :key="currency.id" class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ currency.code }}</th>
                            <td class="px-4 py-3">{{ currency.name }}</td>
                            <td class="px-4 py-3">{{ currency.symbol }}</td>
                            <td class="px-4 py-3">{{ currency.created_at }}</td>
